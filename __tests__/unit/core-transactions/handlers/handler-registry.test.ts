...
beforeEach(() => {
    ...
    app.bind(Identifiers.ApplicationNamespace).toConstantValue("sth-unitnet");
    ...
    app.bind(Identifiers.PluginConfiguration)
        ...
        .when(Container.Selectors.anyAncestorOrTargetTaggedFirst("plugin", "@smartholdem/core-transactions"));
