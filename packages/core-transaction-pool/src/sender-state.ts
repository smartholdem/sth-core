import { Container, Contracts, Enums, Providers, Services } from "@smartholdem/core-kernel";
import { Handlers } from "@smartholdem/core-transactions";
import { Crypto, Interfaces, Managers } from "@smartholdem/crypto";
...
export class SenderState implements Contracts.TransactionPool.SenderState {
    ...
    @Container.tagged("plugin", "@smartholdem/core-transaction-pool")
