import { Container, Contracts, Services, Utils as AppUtils } from "@smartholdem/core-kernel";
import { IEntitiesWallet, IEntityWallet } from "@smartholdem/core-magistrate-transactions";
