import { Types } from "@smartholdem/core-kernel";
...
export class CoreGenerator extends Generator {
    ...
    private writeEnvironment(): void {
        ...
        if (this.options.core.environment) {
            ...
            copyFileSync(require.resolve("@smartholdem/core/bin/config/testnet/.env"), filePath);
        }
    }
    ...
    private writeApplication(): void {
        ...
        if (this.options.core.app) {
            ...
            copyFileSync(require.resolve("@smartholdem/core/bin/config/testnet/app.json"), filePath);
        }
    }
