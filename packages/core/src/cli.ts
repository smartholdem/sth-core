import { ApplicationFactory, Commands, Container, Contracts, InputParser, Plugins } from "@smartholdem/core-cli";
...
export class CommandLineInterface {
    ...
    public async execute(dirname = __dirname): Promise<void> {
        // Set NODE_PATHS. Only required for plugins that uses @smartholdem as peer dependencies.
        this.setNodePath();
