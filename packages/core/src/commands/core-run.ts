import { Commands, Container, Contracts, Utils } from "@smartholdem/core-cli";
...
export class Command extends Commands.Command {
    ...
    public async execute(): Promise<void> {
        ...
        await Utils.buildApplication({
            flags,
            plugins: {
                "@smartholdem/core-p2p": Utils.buildPeerFlags(flags),
                "@smartholdem/core-blockchain": {
                    networkStart: flags.networkStart,
                },
                "@smartholdem/core-forger": await buildBIP38(flags, this.app.getCorePath("config")),
            },
        });
